...
Form
{
	...
	VariablesForm
	{
        ...
        AssignedVariablesList	{ name: "splitBy";			title: qsTr("Split");		info: qsTr("Can be split by a categorical variable such as experimental condition.") ; singleVariable: false; acceptedColumns: ["nominal"];	id: splitBy }
	}
